...
def download_mnist(work_dir):
	...
	path_to_zip_file = os.path.join(work_dir, "mnist_jpgfiles.zip")
	...
	for file in tqdm(os.listdir(train_path_oracle)):
	...
	#move the files to the appropriate folders
	for file in tqdm(os.listdir(test_path_oracle)):
		digit = file[6]
		dir_key = task_dict[digit]
